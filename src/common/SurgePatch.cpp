...
SurgePatch::SurgePatch(SurgeStorage* storage)
{
   ...
   for (int sc = 0; sc < 2; sc++)
   {
      ...
      for (int l = 0; l < n_lfos; l++)
      {
         ...
         a->push_back(scene[sc].lfo[l].mod_trigger.assign(p_mod_triggers.next(), id_s++, label, "Modulation trigger value",
         ...
         a->push_back(scene[sc].lfo[l].mod_trigger_dt.assign(p_mod_triggers.next(), id_s++, label, "Modulation trigger dt",
